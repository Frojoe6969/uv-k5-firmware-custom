...
ENABLE_FMRADIO_875_108           := 0       enable FM radio 87.5MHz ~ 108MHz
ENABLE_FMRADIO_64_108            := 1       enable the FM radios full frequency range
...
ENABLE_MDC1200                   := 1       enable MDC1200 TX/RX + menu TX option
...
ENABLE_RESET_AES_KEY             := 0       '1' = reset/clear the AES key stored in the eeprom (only if it's set)
...
ENABLE_CONTRAST                  := 1       add contrast menu
